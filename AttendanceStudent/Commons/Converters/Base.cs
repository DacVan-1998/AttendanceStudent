...
namespace AttendanceStudent.Commons.Converters
{
    public static class Base
    {
        ...
        public static string Encode(long value)
        {
            ...
            if (value > Constants.MaterializedPath.Max)
                return Constants.MaterializedPath.MaxString;
            if (value < Constants.MaterializedPath.Min)
                return Constants.MaterializedPath.MinString;
            ...
            return encoded.PadLeft(Constants.MaterializedPath.PathLength, '0');
        }
